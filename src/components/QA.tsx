...
const Testimonial = ({
	...
	return (
		<div className="bg-white hover:bg-gray-100/20 border border-neutral-400/20 transition-all rounded-3xl overflow-hidden relative backdrop-blur-2xl">
			...
			<div className="peer-open:max-h-40 max-h-0 overflow-hidden transition-all duration-500 text-neutral-700 dark:text-neutral-200 font-medium transform-gpu">
				<p className="p-8 m-2 bg-gray-100 rounded-2xl ">{content}</p>
			</div>
		</div>
	);
};
